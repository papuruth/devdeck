            ...
            <StyledBoxCenter flexDirection={{ xs: "column", sm: "column", md: "row" }}>
                <StyledBoxCenter justifyContent="center" flexDirection="column">
                    <StyledBoxCenter justifyContent="center" width="90%" sx={{ minHeight: 64 }}>
                        <StyledText component="p" color={colors.primary} sx={{ flexGrow: 1, fontWeight: 700 }}>
                            Enter Base64 String
                        </StyledText>
                        <StyledText component="p" color={colors.secondary} sx={{ fontWeight: 400 }}>
                ...
                <StyledBoxCenter justifyContent="center" flexDirection="column">
                    <StyledBoxCenter justifyContent="center" width="90%" sx={{ minHeight: 64 }}>
                        <StyledText component="p" color={colors.primary} sx={{ fontWeight: 700, flexGrow: 1 }}>
                            Decoded String
                        </StyledText>
                        <StyledText component="p" color={colors.secondary} sx={{ fontWeight: 400 }}>
