...
interface ControlValueProps {
    $active?: boolean;
}
export const ControlValue = styled.span<ControlValueProps>`
...
export const AspectToggle = styled.button<AspectToggleProps>`
...
interface AspectPreviewBoxProps {
    $w?: number;
    $h?: number;
    $active?: boolean;
}
export const AspectPreviewBox = styled.span<AspectPreviewBoxProps>`
...
export const AspectChip = styled.button<AspectChipProps>`
    padding: 4px 8px;
    border-radius: 6px;
...
export const LockBtn = styled.button<LockBtnProps>`
    display: flex;
    align-items: center;
...
export const FormatBtn = styled.button<FormatBtnProps>`
    display: inline-flex;
    align-items: center;
    gap: 4px;
    padding: 7px 12px;
