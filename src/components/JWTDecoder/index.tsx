...
async function verifyHmac(tokenStr: string, secret: string, alg: string, b64Encoded: boolean): Promise<"valid" | "invalid" | "unsupported" | "error"> {
...
function SigVerify({ token, alg, signature }: SigVerifyProps) {
