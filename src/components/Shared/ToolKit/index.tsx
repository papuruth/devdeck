...
interface ActionBtnProps { $success?: boolean; $danger?: boolean; $active?: boolean; }
interface TabBtnProps { $active?: boolean; }
interface ModeBtnProps { $active?: boolean; }

const getActionBtnColor = (props: ActionBtnProps) => {
    if (props.$success) return "#22cc99";
    if (props.$danger) return "#ef4444";
    if (props.$active) return "#22cc99";
    return "var(--text-secondary)";
};

const getActionBtnBorder = (props: ActionBtnProps) => {
    if (props.$success) return "rgba(34,204,153,0.5)";
    if (props.$danger) return "rgba(239,68,68,0.4)";
    if (props.$active) return "rgba(34,204,153,0.4)";
    return "var(--border-color)";
};

const getActionBtnBg = (props: ActionBtnProps) => {
    if (props.$success) return "rgba(34,204,153,0.1)";
    if (props.$danger) return "rgba(239,68,68,0.06)";
    if (props.$active) return "rgba(34,204,153,0.08)";
    return "transparent";
};

const getActionBtnHoverColor = (props: ActionBtnProps) => (props.$danger ? "#ef4444" : "#22cc99");
const getActionBtnHoverBorder = (props: ActionBtnProps) => (props.$danger ? "rgba(239,68,68,0.6)" : "rgba(34,204,153,0.5)");
const getActionBtnHoverBg = (props: ActionBtnProps) => (props.$danger ? "rgba(239,68,68,0.1)" : "rgba(34,204,153,0.08)");
...
const getModeBtnBg = (props: ModeBtnProps) => (props.$active ? "#22cc99" : "transparent");
const getModeBtnColor = (props: ModeBtnProps) => (props.$active ? "#0b1220" : "var(--text-secondary)");
const getModeBtnHoverColor = (props: ModeBtnProps) => (props.$active ? "#0b1220" : "#22cc99");
