export default {
    ...
    jsonViewer: {
        ...
        errorsLabel: "error(s) found",
        schemaEmptyState: "Enter JSON data and a schema, then click Validate",
        noJsonDataNote: "Use the Editor tab to enter JSON data first",
        schemaParseError: "Invalid JSON in schema",
        dataParseError: "Invalid JSON in data",
    ...
    regexTester: {
        ...
        generateEmptyState: "Describe what you want to match"
    },
    jwtDecoder: {
    ...
    uuidGenerator: {
        ...
        inspectEmptyState: "Paste a UUID above to inspect it"
    },
    timestampConverter: {
    ...
    htmlToJsx: {
        ...
        partialConversionWarning: "HTML may be malformed — output is partial",
        transformationsLabel: "transformations applied",
        localLabel: "Local"
    },
    encoderDecoder: {
