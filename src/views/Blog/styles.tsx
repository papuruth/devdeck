...
export const BlogIndexCard = styled(Paper)<BlogIndexCardProps>`
...
export const CategoryChip = styled.button<CategoryChipProps>`
    padding: 5px 14px;
    border-radius: 20px;
...
function rankColor(n: number | undefined) {
...
function rankOpacity(n: number | undefined) {
    if (!n) return 0.45;
    if (n <= 1) return 1;
    if (n <= 3) return 0.8;
    return 0.45;
...
export const PopularRank = styled.span<PopularRankProps>`
    font-size: 0.7rem;
    font-weight: 700;
    font-family: "Inter", sans-serif;
...
export const CardTag = styled.span<CardTagProps>`
    font-size: 0.65rem;
    font-weight: 700;
