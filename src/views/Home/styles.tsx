...
export const HeroSearchBox = styled.div<HeroSearchBoxProps>`
    display: flex;
    align-items: center;
    gap: 10px;
    background: #111827;
...
interface HeroSuggestionItemProps {
    $active?: boolean;
}
export const HeroSuggestionItem = styled.div<HeroSuggestionItemProps>`
    padding: 10px 16px;
    cursor: pointer;
...
interface HeroSmartBannerProps {
    $active?: boolean;
}
export const HeroSmartBanner = styled.div<HeroSmartBannerProps>`
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 10px 16px;
...
interface StyledSectionAccentProps {
    $color?: string;
}
export const StyledSectionAccent = styled.div<StyledSectionAccentProps>`
    width: 4px;
    height: 24px;
    border-radius: 2px;
...
interface StyledCardIconWrapperProps {
    $accentColor?: string;
}
export const StyledCardIconWrapper = styled.div<StyledCardIconWrapperProps>`
    display: flex;
    align-items: center;
    justify-content: center;
    width: 48px;
...
export const LearnLink = styled(NextLink)<LearnLinkProps>`
...
export const LearnViewAll = styled(NextLink)`
    background: none;
